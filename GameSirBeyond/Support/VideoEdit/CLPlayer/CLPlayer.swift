...
extension CLPlayer {
    ...
    typealias CLClickClosure = (CLClickButton) -> Void
    
    typealias CLSliderClosure = () -> Void
}
...
public class CLPlayer: UIView {
    ...
    var clickClosure:CLClickClosure?
    var sliderClosure:CLSliderClosure?
    var readyClosure:CLSliderClosure?
...
//            NotificationCenter.default.addObserver(self, selector: #selector(deviceOrientationDidChange), name: UIDevice.orientationDidChangeNotification, object: nil) //会与app的冲突 造成bug
        }
...
public extension CLPlayer {
    func play() {
        ...
        print("--CLPlayer-isUserPause---\(isUserPause)------")
    }
...
//        }
        if (  self.clickClosure != nil){
              self.clickClosure!(CLClickButton.back)
        }
    }
    ...
    func didClickHighlightButton(in contentView: CLPlayerContentView) {
        if (  self.clickClosure != nil){
              self.clickClosure!(CLClickButton.highlight)
        }
    }
    
    func didClickEditButton(in contentView: CLPlayerContentView) {
        if (  self.clickClosure != nil){
              self.clickClosure!(CLClickButton.edit)
        }
    }
    
    func didClickDownloadButton(in contentView: CLPlayerContentView) {
        if (  self.clickClosure != nil){
              self.clickClosure!(CLClickButton.download)
        }
    }
    
    func didClickDeleteButton(in contentView: CLPlayerContentView) {
        if (  self.clickClosure != nil){
              self.clickClosure!(CLClickButton.delete)
        }
    }
}
