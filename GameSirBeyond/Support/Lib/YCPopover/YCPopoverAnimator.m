...
@property(nonatomic,weak)YCPresentationController  *presentationController;
...
@property(nonatomic,assign)BOOL                       isGestureUse;
...
- (nullable UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(nullable UIViewController *)presenting sourceViewController:(UIViewController *)source{
    ...
    //presentation.gestureIsUse = _isGestureUse;
    ...
    @autoreleasepool {
        ...
        if (self.popoverType == YCPopoverTypeAlert) {
            ...
            [UIView animateWithDuration:kAnimationDuration delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
                ws.presentationController.coverView.alpha = 1.0f;
...
- (void)animationForDismissedView:(nonnull id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    @autoreleasepool {
        ...
        if (self.popoverType == YCPopoverTypeAlert) {
            // 消失
            [UIView animateWithDuration:kAnimationDuration delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
                ws.presentationController.coverView.alpha = 0.0f;
                presentedView.alpha = 0.0f;
            } completion:^(BOOL finished) {
            ...
            [UIView animateWithDuration:kAnimationDuration animations:^{
                ws.presentationController.coverView.alpha = 0.0f;
                presentedView.transform = CGAffineTransformMakeTranslation(0, ws.presentedHeight);
            } completion:^(BOOL finished) {
                [presentedView removeFromSuperview];
                [transitionContext completeTransition:YES];
            }];
...
- (void)setGestureEnbel:(BOOL)isUse {
    _isGestureUse = isUse;
}
